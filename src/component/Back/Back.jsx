...
export default function Back() {
  ...
  async function sendData() {
    await axios.post(
      "https://664a6605a300e8795d41ddd6.mockapi.io/back",
      datainput
    );
    getData();
  ...
  async function deleteUser(id) {
    await axios.delete(
      `https://664a6605a300e8795d41ddd6.mockapi.io/back/${id}`
    );
  ...
  async function updateUser() {
    await axios.put(`https://664a6605a300e8795d41ddd6.mockapi.io/back/${id}`, {
    ...
    <>
      <div className="   container mt-5">
        ...
        <form id="form">
          ...
          {btnupdate ? (
            <button
              className="btn btn-outline-warning  btn-update"
              id="update"
